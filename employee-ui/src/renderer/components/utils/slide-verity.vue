...
<script>
    import {myBrowser} from '@/utils/index'
    const PI = Math.PI;
    function sum(x, y) {
        return x + y
    }
        ...
        methods: {
            ...
            initImg() {
                ...
                let onload =  function(){
                 ...
                 //   const br = myBrowser();
                 //   console.log('br' , br)
                  /*  if(br && br.indexOf('FF') >= 0) {
                  */      
                        this_.canvasCtx.drawImage(this_.img, 0, 0, this_.w, this_.h) 
                        this_.drawBlock()
                        this_.blockCtx.drawImage(this_.img, 0, 0, this_.w, this_.h)
                 ...
                 /*   } else {
                    ...
                    let _y = y - r * 2 - 1
                    let ImageData = this_.blockCtx.getImageData(x, _y, L, L);
                    this_.block.width = L;
                    this_.blockCtx.putImageData(ImageData, 0, _y)
                }

                const img = this.createImg(onload);
                //this.img = img;
            },
            drawBlock() {
            ...
            getRandomImg() {
               ...
               //  return  'url("~@/assets/img'+ this.getRandomNumberByRange(0, 9) + '.jpg")'
                //return '@/assets/img/capt/' + this.getRandomNumberByRange(0, 9) + '.jpg';
            },
...
<style scoped>
    ...
    .slide-verify-slider-mask-item-icon {
        ...
        width: 14px;
        height: 10px;
        background: url("../../assets/img/icon_light.png") 0 -26px;
        background-size: 34px 471px
    }
